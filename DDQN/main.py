...
def draw_elements(agent_pos, fruits, poisons):
    ...
    for f in fruits:
        pygame.draw.circle(
            WIN,
            COLOR_FRUIT,
            (f[1] * CELL_SIZE + CELL_SIZE // 2, f[0] * CELL_SIZE + CELL_SIZE // 2),
            CELL_SIZE // 3,
        )
    # Dibujar venenos
    for p in poisons:
...
def main():
    ...
    while run:
            ...
            if mode == "setup":
                ...
                if event.type == pygame.KEYDOWN:
                    if event.key == pygame.K_SPACE:
                        ...
                        state = env.reset(
                            agent_pos=(0, 0), fruit_pos=fruits, poison_pos=poisons
                        )
        ...
        if mode == "setup":
            ...
            draw_elements(
                np.array([-1, -1]), fruits, poisons
            )  # Agente fuera de pantalla
